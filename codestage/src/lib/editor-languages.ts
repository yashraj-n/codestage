...
const pythonCompletions: languages.CompletionItem[] = [
	...
	},
	{
		label: "__init__",
		kind: 0,
		insertText: "def __init__(self${1:, params}):\n\t${2:pass}",
		insertTextRules: 4,
	...
	},
	{
		label: "raise",
		kind: 14,
		insertText: "raise ${1:Exception}(${2})",
		insertTextRules: 4,
...
const javaCompletions: languages.CompletionItem[] = [
	...
	{ label: "false", kind: 14, insertText: "false", detail: "Boolean false" },
	{
		label: "import",
		kind: 14,
		insertText: "import ${1:package.Class};",
		insertTextRules: 4,
	...
	},
	{
		...
		insertTextRules: 4,
		detail: "Implements clause",
	},
	{
		label: "extends",
		kind: 14,
		insertText: "extends ${1:Class}",
		insertTextRules: 4,
		detail: "Extends clause",
	},
	{
		label: "ArrayList",
		kind: 5,
		...
		insertTextRules: 4,
		detail: "ArrayList creation",
	},
	{
		label: "HashMap",
		kind: 5,
		insertText: "HashMap<${1:Key}, ${2:Value}> ${3:name} = new HashMap<>();",
		insertTextRules: 4,
		detail: "HashMap creation",
	},
	{
		label: "HashSet",
		kind: 5,
		insertText: "HashSet<${1:Type}> ${2:name} = new HashSet<>();",
		insertTextRules: 4,
		detail: "HashSet creation",
	},
	{
	...
	},
	{
		label: "instanceof",
		kind: 14,
		insertText: "instanceof ${1:Type}",
		insertTextRules: 4,
		detail: "Instance check",
	},
...
const cppCompletions: languages.CompletionItem[] = [
	...
	},
	{
		label: "pair",
		kind: 5,
		insertText: "pair<${1:first}, ${2:second}> ${3:name};",
		insertTextRules: 4,
	...
	},
	{
		...
		kind: 5,
		insertText:
			"unique_ptr<${1:Type}> ${2:name} = make_unique<${1:Type}>(${3});",
		insertTextRules: 4,
		detail: "Unique pointer",
	},
	{
		label: "shared_ptr",
		kind: 5,
		insertText:
			"shared_ptr<${1:Type}> ${2:name} = make_shared<${1:Type}>(${3});",
		insertTextRules: 4,
		detail: "Shared pointer",
	},
	{
		label: "push_back",
		kind: 0,
		insertText: "push_back(${1})",
		insertTextRules: 4,
		detail: "Add to vector",
	},
...
export function registerLanguageCompletions(monaco: Monaco) {
	monaco.languages.registerCompletionItemProvider("python", {
		provideCompletionItems: (
			...
			return {
				suggestions: pythonCompletions.map((item) => ({ ...item, range })),
			};
		},
	});
	...
	monaco.languages.registerCompletionItemProvider("java", {
		provideCompletionItems: (
			...
			return {
				suggestions: javaCompletions.map((item) => ({ ...item, range })),
			};
		},
	});
	...
	monaco.languages.registerCompletionItemProvider("cpp", {
		provideCompletionItems: (
			...
			return {
				suggestions: cppCompletions.map((item) => ({ ...item, range })),
			};
		},
	});
}
