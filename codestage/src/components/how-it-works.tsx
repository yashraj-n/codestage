...
import { Plus, Link, Play, CheckCircle2 } from "lucide-react"
...
const steps = [
  {
    ...
    step: "01",
    title: "Create a Room",
    description: "Generate a secure session with a single click. Your workspace is ready instantly.",
  ...
  },
  {
    ...
    description: "Share the link with your candidates. They join directly in browser.",
    features: ["No sign-up required", "Up to 5 participants", "Permission controls"],
  },
  {
    icon: Play,
    step: "03",
    title: "Start Interviewing",
    description: "Collaborate in real-time with shared notes, code editor, and terminal.",
    features: ["Live code execution", "Shared annotations", "Session recording"],
  },
]
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-20 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            Get started in minutes, not hours. Our streamlined process ensures you spend more time interviewing.
          </p>
        </div>
            ...
            <div key={step.step} className="relative">
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-card/30 p-8 backdrop-blur-sm transition-all duration-500 hover:border-border hover:bg-card/50">
                ...
                <div className="absolute -right-4 -top-4 flex h-24 w-24 items-center justify-center">
                  <span className="text-6xl font-bold text-secondary/60">{step.step}</span>
                </div>
