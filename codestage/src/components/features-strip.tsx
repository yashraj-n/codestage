...
import { Pencil, Layout, Shield, Zap, Users, Lock } from "lucide-react"

const features = [
  {
    icon: Zap,
    title: "Instant Setup",
    description: "Create a session in seconds. No downloads, no configuration required.",
  },
  {
    icon: Pencil,
    title: "Real-Time Editing",
    description: "Monaco-powered editor with live collaboration and syntax highlighting.",
  },
  {
    icon: Layout,
  ...
  },
  {
    ...
    description: "Invite up to 5 participants with granular permission controls.",
  },
  {
    icon: Shield,
...
export function FeaturesStrip() {
  ...
  return (
    <section id="features" className="relative border-y border-border/40 bg-secondary/20 px-6 py-24">
      {/* Glow line at top */}
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-16 text-center">
          ...
          <p className="mt-4 text-muted-foreground">Powerful features designed for seamless technical interviews</p>
        </div>
