    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <p className="mt-6 max-w-2xl text-balance text-lg text-muted-foreground md:text-xl">
          Real-time collaborative coding built for technical interviews. Securely conduct, monitor, and evaluate
          candidates with zero setup.
        </p>

        {/* CTAs */}
        <div className="mt-10 flex flex-col gap-4 sm:flex-row">
          <Button size="lg" className="group h-12 bg-foreground px-8 text-background hover:bg-foreground/90">
            Start a Session
